 ...
 */
class IntegerToLocationConverter extends \F3\FLOW3\Property\TypeConverter\AbstractTypeConverter {
	 ...
	 * @var string
	 */
	protected $targetType = 'F3\Events\Domain\Model\Location';
	...
	public function convertFrom($source, $targetType, array $subProperties = array(), \F3\FLOW3\Property\PropertyMappingConfigurationInterface $configuration = NULL) {
		$location = $this->locationRepository->findOneById($source);
		return $location;
	}
}
